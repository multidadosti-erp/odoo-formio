...
class ServiceContract(models.Model):
    ...
    formio_forms = fields.One2many('formio.form', 'contract_id', string='Forms')
    ...
    def _compute_formio_this_model_id(self):
        self.ensure_one()
        model_id = self.env.ref('service_contract_management.model_service_contract').id
    ...
    def write(self, vals):
        ...
        res = super(ServiceContract, self).write(vals)
